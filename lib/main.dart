...
void main() async {
  ...
  await Hive.openBox<UserHive>(AppConstant.usersBox);
  await Hive.openBox<ConversationHive>(AppConstant.conversationsBox);
  await Hive.openBox<MessageHive>(AppConstant.messagesBox);
